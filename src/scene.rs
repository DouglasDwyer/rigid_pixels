...
pub fn circle_rotation_jitter() -> PixelWorld {
    ...
    world.insert(create_circle_body(ORANGE, Transform { position: vec2(-20.0, 10.0), rotation: 0.2 }, 9.0));
    world
}

/// Creates a filled circle.
fn create_circle_body(color: Color, transform: Transform, radius: f32) -> PixelObject {
...
fn create_floor2() -> PixelObject {
    ...
    PixelObject::new(body, DARKGRAY, Transform { position: vec2(0.0, -5.0), rotation: 0.0 })
}